    ...
    <form class="row g-3 mb-3">
        ...
        <!-- <div class="col-md-12">
          ...
          <div class="col-md-6">
            ...
            <input  onkeyup="inputvalidate()" id="pan" type="email" class="form-control" id="inputEmail4">
            <span id="display" style="color:red; font-size: 14px;">*</span>
          </div>
          <div class="col-md-6">
            <label for="inputEmail4" class="form-label">Enter Aadhar Number</label>
            <input onkeyup="inputvalidate2()" id="aadhar" type="email" class="form-control" id="inputEmail4">
        ...
        <div class="col-md-6">
          ...
          <input onkeyup="Movalidate()" id="mobile" type="text" class="form-control" id="inputEmail4">
          <span id="mdisplay" style="color:red; font-size: 14px;">*</span>
        </div>
        <div class="col-md-6">
          <label for="inputPassword4" class="form-label">Enter Email Number</label>
          <input onkeyup="validateEmail()" id="email" type="email" class="form-control" id="inputPassword4">
...
function Movalidate() {
    ...
    if (mobile.value.trim() === "") {
        ...
        if (reg.test(mobile.value) && mobile.value.length === 10) {
