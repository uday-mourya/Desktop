...
.loan {
    margin-top: 50px; /* You can adjust the value (e.g., 50px) based on your preference */
}
...
<form class="row g-3 border">
  ...
  <div class="col-md-12">
    ...
    <div class="col-md-6 ">
      ...
      <input onkeyup="namevalidate()" id="name" type="text" class="form-control" id="inputEmail4">
  ...
  <form class="row g-3 border">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-6 my-4 mb-4">
       ...
       <div class="col-md-6 my-4 mb-4">
          <label for="inputState" class="form-label " style="width:200px;">Country</label>
          <select id="inputState" class="form-select form-control mx-auto w-100">
            <option selected>Choose...</option>
            <option>...</option>
          </select>
