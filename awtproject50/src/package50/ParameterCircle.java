...
class ParameterCircle extends Frame implements WindowListener,ActionListener{
    Label lb1,lb2,lb3;
    TextField txf;
    Button bt1,bt2;
    public ParameterCircle(){
        this.setVisible(true);
        this.setBounds(100, 80, 450, 280);
        this.setTitle("Prime");
        ...
        bt2.setBounds(200,180,190,30);
        bt2.setBackground(Color.white);
        this.add(bt2);

        lb2=new Label();
        lb2.setBounds(200, 120, 190, 30);
