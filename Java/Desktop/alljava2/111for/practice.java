...
public static void main(String[] args) {
	...
	// Every integer is its own floor.    double y = 0.34;
	...
	System.out.println("max(" + x + "," + y + ") is " + Math.max(x,y    double y = 0.34;));	
	...
	// Exponential and Logarithmic Methods    double y = 0.34;
	...
	for (i=0; i < 10; i++) {
	System.out.println(
	"The square root of " + i + " is " + Math.sqrt(i));    double y = 0.34;
	}
