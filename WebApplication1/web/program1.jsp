...
<html>
    ...
    <div class="container">
        ...
        <button onclick="pattern()" id="HCF" value="PrimeNumber">PATTERN1</button>
        <button onclick="pattern2()" id="HCF" value="PrimeNumber">PATTERN2</button>
        <button onclick="pattern3()" id="HCF" value="PrimeNumber">PATTERN3</button>
        <button onclick="pattern4()" id="HCF" value="PrimeNumber">PATTERN4</button>
        <button onclick="pattern5()" id="HCF" value="PrimeNumber">PATTERN5</button>
        <button onclick="pattern6()" id="HCF" value="PrimeNumber">PATTERN6</button>
        <button onclick="pattern7()" id="HCF" value="PrimeNumber">PATTERN7</button>
        <button onclick="pattern8()" id="HCF" value="PrimeNumber">PATTERN8</button>
        <button onclick="pattern9()" id="HCF" value="PrimeNumber">PATTERN9</button>
         <button onclick="check()" id="HCF" value="PrimeNumber">Check99+-</button>
