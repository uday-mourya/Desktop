...
//             String fname=rs.getString(2);
            ...
            out.println("<ul>");
            out.println("<li><a  href='Dashboard4'>Home</a></li>");
            out.println("<li><a  href='Dashboard4'>About Us</a></li>");
            out.println("<li><a  href='Dashboard4'>Gallery</a></li>");
//            out.println("<td>"+"<a href='Editor?Email="+rs.getString("Email")+"'>Edit</a>"+"</td>");
            out.println("<li><a href='profiles'>Profile</a></li>");
