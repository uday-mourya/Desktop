...
<body>
    ...
    <div id='nav'>
      <ul>
        ...
        <li><a href='Adminpassword.jsp'>UpdatePassword</a></li>
        <li><span><a href='Adminlogout.jsp'>Logout</a><span></li>
      </ul>
    </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Delete User From Id </h5>
       
        <a href="Deleteid.jsp" class="btn btn-primary">Go</a>
      </div>
    </div>
  </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <a href="MobileUpdate.jsp" class="btn btn-primary">Go</a>
      </div>
    </div>
  </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <a href="Admininsert.jsp" class="btn btn-primary">Go</a>
      </div>
    </div>
  </div>
