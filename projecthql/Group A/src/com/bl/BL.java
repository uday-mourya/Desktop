...
public class BL {
    ...
    public void vehicle(Scanner scanner, BL b) {
        switch (b.choiceOperation(scanner)) {
            ...
            case 4: {
                System.out.print("Enter Vehicle id : ");
                id = scanner.nextInt();
                List<VehiclePOJO> vehicleList = (List<VehiclePOJO>) b.display("FROM VehiclePOJO where id = " + id);
    ...
    public void faculty(Scanner scanner, BL b) {
        switch (b.choiceOperationWithLike(scanner)) {
            case 1: {
                scanner.nextLine();
                VehiclePOJO v = new VehiclePOJO();
            ...
            case 2: {
                System.out.println("Enter name of faculty person : ");
                scanner.nextLine();
                String name = scanner.nextLine();
                String hqlQuery = "FROM FacultyPOJO WHERE first_name = "+name+" OR last_name = "+name;
                List<FacultyPOJO> facultyList = (List<FacultyPOJO>) b.display(hqlQuery);
            ...
            case 4: {
                System.out.print("Enter Mobile id : ");
                id = scanner.nextInt();
                List<FacultyPOJO> facultyList = (List<FacultyPOJO>) b.display("FROM VehiclePOJO where id = " + id);
                break;
            }
            case 5: {
            ...
            case 6: {
                List<FacultyPOJO> facultyList = (List<FacultyPOJO>) b.display("FROM VehiclePOJO");
            }
            case 7: {
                b.choice(scanner, b);
                break;
    ...
    public int choiceOperationWithLike(Scanner sc) {
        ...
        System.out.println("Press 6 for All Data : ");
        System.out.println("Press 7 for Home :");
