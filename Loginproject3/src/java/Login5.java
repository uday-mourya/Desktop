...
//out.print("    background: linear-gradient(120deg, #007bff, #d0314c);");
          ...
          if(bt.equals("login")) 
          {
            ...
            try {
                ...
                con = java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/server?useSSL=false", "root", "udaysql@350");
...
//                    RequestDispatcher rd = request.getRequestDispatcher("Login4");
