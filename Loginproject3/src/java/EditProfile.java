...
//            if (rs != null) {
                ...
                out.print("               <td>:</td>");
                out.print("               <td><input type='text' name='name' required ></td>");
                out.print("             </tr>");
                out.print("             <tr>");
                out.print("               <td>Father</td>");
                out.print("               <td>:</td>");
                out.print("               <td><input type='text' name='fname' required></td>");
                out.print("             </tr>");
                out.print("             <tr>");
                out.print("               <td>Mobile</td>");
                out.print("               <td>:</td>");
                out.print("               <td><input type='text' name='mobile' required ></td>");
                out.print("             </tr>");
                out.print("             <tr>");
                out.print("               <td>Email</td>");
                out.print("               <td>:</td>");
                out.print("               <td><input type='text' name='email' required ></td>");
                out.print("             </tr>");
                out.print("             <tr>");
                out.print("               <td>Password</td>");
                out.print("               <td>:</td>");
                out.print("               <td><input type='password' name='pass' required ></td>");
                out.print("             </tr>");
                out.print("             <tr>");
                out.print("               <td>C Password</td>");
                out.print("               <td>:</td>");
                out.print("               <td><input type='password' name='cpassword' required></td>");
                out.print("             </tr>");
                out.print("             <tr>");
                out.print("               <td><input type='submit' value='Save'></td>");
                out.print("             </tr>");
            Object x = session.getAttribute("error");
                if (x.equals(1)) {
...
//            } 
//else {
//                response.sendRedirect(request.getContextPath() + "/Login4");
//            }
        }
    }
