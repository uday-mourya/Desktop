            ...
            out.print("<table align='center'  cellspacing='0' height='300px' width='600px'>");
              ...
              out.print("</center>");
                out.print("<tr>");
                    ...
                    out.print("</td>");
                    out.print("<td align='center'>");
                        out.print("<input type='text' pattern=\"[A-Za-z]+\" name='name' value='" + rs1.getString(1) + "'>");
                    out.print("</td>");
                out.print("</tr>");  
                out.print("<tr>");
                    out.print("<td align='center'>");
                    ...
                    out.print("</td>");
                    out.print("<td align='center'>");
                        out.print("<input type='text' name='fname' pattern=\"[A-Za-z]+\" value='" + rs1.getString(2) + "'>");
                    out.print("</td>");
                out.print("</tr>"); 
                out.print("<tr>");
                    out.print("<td align='center'>");
                ...
                out.print("</tr>"); 
                    ...
                    out.print("</td>");
                    out.print("<td align='center'>");
                        out.print("<input type='tel' name='mobno' min=\"1\" max=\"10\" value='" + rs1.getString(5) + "'>");
                    out.print("</td>");
