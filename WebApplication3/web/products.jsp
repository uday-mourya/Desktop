...
<%@ page import="your_package_name.ProductDTO" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="row mt-5 mx-0 justify-content-center align-items-center">
    <% for (ProductDTO product : (List<ProductDTO>) request.getAttribute("products")) { %>
        <div class="col-lg-3 col-md-4 col-12 card-wrapper">
            <div class="card mt-4">
                <!-- Display product information -->
                <div class="card-body text-center">
                    <h6 class="card-title"><%= product.getName() %></h6>
                    <p class="card-text text-secondary">Color: <%= product.getColor() %></p>
                    <p class="card-text text-secondary">Size: <%= product.getSize() %></p>
                    <!-- Add more details as needed -->
                    <a href="#" class="btn btn-danger text-center">Add to Cart</a>
                </div>
            </div>
        </div>
    <% } %>
