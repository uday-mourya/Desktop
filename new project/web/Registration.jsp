<%-- 
    ...
    Created on : 19-Nov-2023, 2:55:23 pm
    Author     : T460
--%>
  ...
  text-decoration: underline;
   ...
   <script>
            function validateForm() {
                ...
                if (user == false || fname == false || email == false || pass == false || cpass == false || mobile == false) {
                    return false;
                }
   ...
   <body>
       ...
       <div class="wrapper">
         <div class="title">
            NEW EMPLOYEE        <%@include file="navbar.jsp"  %>
          ...
          <form action="RegistrationTask" onsubmit="return validateForm()">
             ...
             <div class="field">
               <input type="text" onkeyup="validateFname()" id="fname" name="fname" required>
            ...
            <div class="field">
               <input type="text"  onkeyup="validateMobile()" id="mob" name="contact" required>
