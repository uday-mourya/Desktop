                    ...
                    <ul class="links">
                        ...
                        <li>
                            ...
                            <ul class="htmlCss-sub-menu sub-menu">
                                ...
                                <li><a href="#" data-bs-toggle="modal" data-bs-target="#ModalForm2">Registration</a></li>
        ...
        <form action="LoginTask">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <a href="LoginTask" class="float-end">Forgot Password</a>
          ...
          <p class="text-center">You Have No Account , <a href="" data-bs-toggle="modal" data-bs-target="#ModalForm">Registration</a></p> 
      </form>
    </div>
  </div>
</div>
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <label class="form-check-label" for="remember">Remember Me</label>
                            ...
                            <button type="submit" class="btn btn-success mx-auto w-100">Registration</button>
            </div>
          </div>
          <div class="modal-footer pt-4">                  
